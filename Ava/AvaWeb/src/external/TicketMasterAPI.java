...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "2dvoOjAtimV0NKRAm6dcxXjkhibK6qfW";
	
	public ArrayList search(double lat, double lon, String keyword) {
		if (keyword == null) {
		...
		try {
			...
			if (!obj.isNull("_embedded")) {
				JSONObject embedded = obj.getJSONObject("_embedded");
				 return (ArrayList) getItemList(embedded.getJSONArray("events"));
			}
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
	...
	private void queryAPI(double lat, double lon) {
		List<Item> events = (List<Item>) search(lat, lon, null);
